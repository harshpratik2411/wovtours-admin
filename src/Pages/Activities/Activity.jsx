...
const Activities = () => {
  ...
  const filtered = ActivityUi.filter((Activities) =>
    Activities.name.toLowerCase().includes(searchText.toLowerCase())
  );
  ...
  return (
    <>
      <Navbar />
      <Sidebar /> 
        <h1 className='text-3xl font-bold -mt-10 text-center lg:ml-32 mb-10'>Activities</h1>
