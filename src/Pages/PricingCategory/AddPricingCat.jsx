...
const AddPricingCat = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await PricingCatServices.add(formData);
      if (result) {
        showAlert("Pricing-Category added successfully!", "success");
        navigate("/pricing-category");
      } else {
        showAlert("Failed to add Pricing-Category .", "error");
      }
    } catch (error) {
