...
const ViewTripTypes = () => {
  const { id } = useParams()
  const TripTypes = DestinationUi.find((t) => t.id === id)
          ...
          <div className="grid lg:grid-cols-2  gap-8 text-gray-700 text-base lg:text-lg mb-10">
            <div className="space-y-4 ">
              <div className="flex gap-3">
                <span className="font-semibold lg:ml-0 ml-5 w-32">Trip Type Name:</span>
                <span className='-ml-3'>{TripTypes.name}</span>
              </div>
              <div className="flex gap-3">
              ...
              <div className="flex lg:-ml-6 -ml-0 gap-3">
                <span className="font-semibold lg:ml-6 ml-5 w-32">Featured:</span>
                   <span className='-ml-3'>{TripTypes.featured}</span>
              </div>
            </div>
