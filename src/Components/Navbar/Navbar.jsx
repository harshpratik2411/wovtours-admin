...
const Navbar = () => {
  ...
  return ( 
    <div
      className="w-full ml-10 lg:mt-0 -mt-8 flex flex-col sm:flex-row lg:justify-between lg:items-center px-4 sm:px-6 py-3 sm:space-y-0 space-y-4 rounded-lg bg-custom-gray"
    >
      {/* Title - Visible only on large screens */}
      <h1 className="text-2xl ml-20 font-bold hidden lg:flex font-Rubik text-gray-800">
        Dashboard
      </h1>
