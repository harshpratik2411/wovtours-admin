...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <button
        className="lg:hidden fixed top-1 left-1 z-50 bg-primary text-white p-2 rounded-md shadow-md"
      ...
      <div className="mt-10">
        <div
          className={`
            fixed top-0 left-0 z-40 h-screen bg-primary text-white font-rubik px-6 py-8 flex flex-col justify-between rounded-xl
          ...
          <div className="flex flex-col justify-between h-full">
            ...
            <div className="overflow-y-auto h-[calc(100vh-4rem)] pr-1">
              ...
              <div className="space-y-6">
                ...
                <div
                  className="flex items-center gap-3 text-white/80 hover:text-white transition cursor-pointer"
                  onClick={openConfirmLogout}
                >
                  <MdLogout className="text-xl" />
                  <button className="bg-primary text-white -ml-4 px-4 py-2 rounded">
                    Logout
                  </button>
                </div>
              </div>
              ...
              {/* Promotional Box */}
              <div className="bg-gradient-to-r from-cyan-500 to-blue-500 h-52 rounded-xl p-4 mt-8 text-center">
                <p className="text-md text-xl mt-10 font-bold">WOV Tours</p>
